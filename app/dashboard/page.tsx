		...
		<div className="flex flex-col gap-5 leading-relaxed">
			<div className="flex flex-col gap-3">
				...
				<p>
					...
					will guide you through building your personal AI
					representative for your LUKSO Universal Profile. Here's what
					you need to know:
				</p>
				<ol className="list-decimal list-inside flex flex-col gap-2 border-indigo-400/20 border-l-4 pl-5">
					<li>
						<strong>Answer the question</strong> - Provide as much
						detail as you feel comfortable sharing. Detailed,
						thorough answers will result in a more knowledgeable
						assistant that can better represent you.
					</li>
					<li>
						<strong>Skip the question</strong> - If you prefer not
						to answer a particular question, you can skip it and
						move on to the next one. Your assistant will simply not
						have information on this topic and will remember not to
